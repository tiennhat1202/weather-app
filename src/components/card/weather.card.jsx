  ...
  return (
    <div className="w=[22rem] min-w-[22rem] h-[30rem] glassCard p-4">
      <div className="flex w-full justify-center items-center gap-4 mt-12 mb-4">
        <img src={icon} alt="weather-con"></img>
      ...
      <div className="w-full flex justify-center items-center mt-4 gap-4">
        ...
        <p className="flex-1 text-center p-2 font-bold bg-green-600 rounded-lg">
          Himidity <span className="font-normal"> {humidity}</span>
        </p>
      </div>
